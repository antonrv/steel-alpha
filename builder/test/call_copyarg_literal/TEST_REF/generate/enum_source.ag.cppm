...
import <cstdio>;
export
namespace app{enum class call : enum_uint_t {main_entry_barapp_0 = 2};using enabled_calls = util::sequence::enum_t<call,call::main_entry_barapp_0>;}
export
...
};template <> struct value<app::call::main_entry_barapp_0>{static constexpr const char * name = "main_entry_barapp_0";}
;}export
namespace app{enum class id : enum_uint_t {barapp = 2,main_entry = global::EntryAppIndex};using enabled_ids = util::sequence::enum_t<id,id::barapp,id::main_entry>;}
export
...
;}export
namespace app{enum class impl : enum_uint_t {bar = 2,main_entry = global::EntryAppImpl};using enabled_impls = util::sequence::enum_t<impl,impl::bar,impl::main_entry>;}
export
