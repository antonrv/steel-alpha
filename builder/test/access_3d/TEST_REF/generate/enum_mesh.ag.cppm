...
;}export
namespace app{enum class id : enum_uint_t {caller1_foo = 2,caller2_foo = 3,caller3_foo = 4,caller4_foo = 5,fooapp_3d = 6};using enabled_ids = util::sequence::enum_t<id,id::caller1_foo,id::caller2_foo,id::caller3_foo,id::caller4_foo,id::fooapp_3d>;}
export
...
;}export
namespace app{enum class impl : enum_uint_t {caller1_foo = 2,caller2_foo = 3,caller3_foo = 4,caller4_foo = 5,foo = 6};using enabled_impls = util::sequence::enum_t<impl,impl::caller1_foo,impl::caller2_foo,impl::caller3_foo,impl::caller4_foo,impl::foo>;}
export
